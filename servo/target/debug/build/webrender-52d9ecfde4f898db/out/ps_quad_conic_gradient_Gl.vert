...
void main ()
{
  ...
  v_gradient_repeat.x = tmpvar_61.w;
  float tmpvar_62;
  tmpvar_62 = (tmpvar_61.y - tmpvar_61.x);
  float tmpvar_63;
  if ((tmpvar_62 != 0.0)) {
  ...
  v_start_offset_offset_scale_angle_vec.y = tmpvar_63;
  v_start_offset_offset_scale_angle_vec.z = (1.570796 - tmpvar_61.z);
  v_start_offset_offset_scale_angle_vec.x = (tmpvar_61.x * tmpvar_63);
  v_dir = (((tmpvar_53 - tmpvar_54) * tmpvar_60.zw) - tmpvar_60.xy);
}
