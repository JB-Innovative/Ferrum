...
void main ()
{
  ...
  if ((int(aSourceRectType) == 1)) {
    ...
    vec2 tmpvar_5;
    tmpvar_5 = vec2(textureSize (sColor0, 0));
    vUvRect = (tmpvar_4 / tmpvar_5.xyxy);
    vUv = (vUv / tmpvar_5);
  };
  vec4 tmpvar_6;
  tmpvar_6.zw = vec2(0.0, 1.0);
  tmpvar_6.xy = mix (aScaleTargetRect.xy, aScaleTargetRect.zw, aPosition);
  gl_Position = (uTransform * tmpvar_6);
}
