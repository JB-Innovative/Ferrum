...
void main ()
{
  ...
  if (((tmpvar_28 & 2) != 0)) {
    ...
    vec2 tmpvar_52;
    tmpvar_52 = (segment_rect_p1_25 - segment_rect_p0_24);
    stretch_size_42 = tmpvar_52;
    if (((tmpvar_28 & 512) != 0)) {
      vec2 tmpvar_53;
      tmpvar_53 = (tmpvar_51.zw - tmpvar_51.xy);
      uv0_46 = (tmpvar_51.xy + (segment_data_26.xy * tmpvar_53));
      uv1_45 = (tmpvar_51.xy + (segment_data_26.zw * tmpvar_53));
    };
    if (((tmpvar_28 & 512) != 0)) {
      ...
      vec2 tmpvar_58;
      tmpvar_58 = (uv1_45 - uv0_46);
      vertical_uv_size_54 = tmpvar_58;
      if (((tmpvar_28 & 256) != 0)) {
        repeated_stretch_size_56 = (segment_rect_p0_24 - tmpvar_6.xy);
        vertical_uv_size_54.x = (uv0_46.x - tmpvar_51.x);
        if (((vertical_uv_size_54.x < 0.001) || (repeated_stretch_size_56.x < 0.001))) {
          vertical_uv_size_54.x = (tmpvar_51.z - uv1_45.x);
          repeated_stretch_size_56.x = (tmpvar_6.z - segment_rect_p1_25.x);
        };
        horizontal_uv_size_55.y = (uv0_46.y - tmpvar_51.y);
        if (((horizontal_uv_size_55.y < 0.001) || (repeated_stretch_size_56.y < 0.001))) {
          horizontal_uv_size_55.y = (tmpvar_51.w - uv1_45.y);
          repeated_stretch_size_56.y = (tmpvar_6.w - segment_rect_p1_25.y);
        };
      };
      if (((tmpvar_28 & 4) != 0)) {
        stretch_size_42.x = (repeated_stretch_size_56.y * (tmpvar_57.x / horizontal_uv_size_55.y));
      };
      if (((tmpvar_28 & 8) != 0)) {
        stretch_size_42.y = (repeated_stretch_size_56.x * (tmpvar_58.y / vertical_uv_size_54.x));
      };
    } else {
      if (((tmpvar_28 & 4) != 0)) {
    ...
    if (((tmpvar_28 & 16) != 0)) {
      float tmpvar_59;
      tmpvar_59 = (segment_rect_p1_25.x - segment_rect_p0_24.x);
      stretch_size_42.x = (tmpvar_59 / max (1.0, roundEven(
        (tmpvar_59 / stretch_size_42.x)
      )));
    };
    if (((tmpvar_28 & 32) != 0)) {
      float tmpvar_60;
      tmpvar_60 = (segment_rect_p1_25.y - segment_rect_p0_24.y);
      stretch_size_42.y = (tmpvar_60 / max (1.0, roundEven(
        (tmpvar_60 / stretch_size_42.y)
      )));
    };
  };
  float tmpvar_61;
  ...
  vec2 tmpvar_62;
  tmpvar_62 = min (uv0_46, uv1_45);
  vec2 tmpvar_63;
  tmpvar_63 = max (uv0_46, uv1_45);
  vec4 tmpvar_64;
  tmpvar_64.xy = (tmpvar_62 + vec2(0.5, 0.5));
  tmpvar_64.zw = (tmpvar_63 - vec2(0.5, 0.5));
  v_uv_sample_bounds = (tmpvar_64 / tmpvar_49.xyxy);
  vec2 tmpvar_65;
  tmpvar_65 = ((tmpvar_37 - local_rect_p0_43) / (local_rect_p1_44 - local_rect_p0_43));
  f_41 = tmpvar_65;
  if ((tmpvar_12.y == 1)) {
    int tmpvar_66;
    tmpvar_66 = (instance_resource_address_3 + 2);
    ivec2 tmpvar_67;
    tmpvar_67.x = int((uint(tmpvar_66) % 1024u));
    tmpvar_67.y = int((uint(tmpvar_66) / 1024u));
    vec4 tmpvar_68;
    tmpvar_68 = mix (mix (texelFetchOffset (sGpuCache, tmpvar_67, 0, ivec2(0, 0)), texelFetchOffset (sGpuCache, tmpvar_67, 0, ivec2(1, 0)), tmpvar_65.x), mix (texelFetchOffset (sGpuCache, tmpvar_67, 0, ivec2(2, 0)), texelFetchOffset (sGpuCache, tmpvar_67, 0, ivec2(3, 0)), tmpvar_65.x), tmpvar_65.y);
    f_41 = (tmpvar_68.xy / tmpvar_68.w);
  };
  vec2 tmpvar_69;
  tmpvar_69 = ((local_rect_p1_44 - local_rect_p0_43) / stretch_size_42);
  v_uv = (mix (uv0_46, uv1_45, f_41) - tmpvar_62);
  v_uv = (v_uv * tmpvar_69);
  bvec2 tmpvar_70;
  tmpvar_70.x = bool((tmpvar_28 & 64));
  tmpvar_70.y = bool((tmpvar_28 & 128));
  v_uv = (v_uv + (mix(vec2(0.0, 0.0), 
    (1.0 - fract(((tmpvar_69 * 0.5) + 0.5)))
  , bvec2(tmpvar_70)) * (tmpvar_63 - tmpvar_62)));
  v_uv = (v_uv / tmpvar_49);
  if ((tmpvar_61 == 0.0)) {
    v_uv = (v_uv * tmpvar_39.w);
  };
  vec4 tmpvar_71;
  tmpvar_71.xy = tmpvar_62;
  tmpvar_71.zw = tmpvar_63;
  v_uv_bounds = (tmpvar_71 / tmpvar_49.xyxy);
