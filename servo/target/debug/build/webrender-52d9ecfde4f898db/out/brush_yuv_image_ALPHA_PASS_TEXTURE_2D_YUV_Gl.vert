...
void main ()
{
  ...
  if (((tmpvar_52 == 3) || (tmpvar_52 == 99))) {
    ...
    vec4 tmpvar_78;
    tmpvar_78.xy = (tmpvar_72.xy + vec2(0.5, 0.5));
    tmpvar_78.zw = (tmpvar_72.zw - vec2(0.5, 0.5));
    vUv_Y = (mix (tmpvar_72.xy, tmpvar_72.zw, f_49) / tmpvar_77);
    vUvBounds_Y = (tmpvar_78 / tmpvar_77.xyxy);
    vec2 tmpvar_79;
    tmpvar_79 = vec2(textureSize (sColor1, 0));
    vec4 tmpvar_80;
    tmpvar_80.xy = (tmpvar_74.xy + vec2(0.5, 0.5));
    tmpvar_80.zw = (tmpvar_74.zw - vec2(0.5, 0.5));
    vUv_U = (mix (tmpvar_74.xy, tmpvar_74.zw, f_49) / tmpvar_79);
    vUvBounds_U = (tmpvar_80 / tmpvar_79.xyxy);
    vec2 tmpvar_81;
    tmpvar_81 = vec2(textureSize (sColor2, 0));
    vec4 tmpvar_82;
    tmpvar_82.xy = (tmpvar_76.xy + vec2(0.5, 0.5));
    tmpvar_82.zw = (tmpvar_76.zw - vec2(0.5, 0.5));
    vUv_V = (mix (tmpvar_76.xy, tmpvar_76.zw, f_49) / tmpvar_81);
    vUvBounds_V = (tmpvar_82 / tmpvar_81.xyxy);
  } else {
    if (((tmpvar_52 == 0) || (tmpvar_52 == 1))) {
      ivec2 tmpvar_83;
      tmpvar_83.x = int((uint(tmpvar_13.x) % 1024u));
      tmpvar_83.y = int((uint(tmpvar_13.x) / 1024u));
      vec4 tmpvar_84;
      tmpvar_84 = texelFetchOffset (sGpuCache, tmpvar_83, 0, ivec2(0, 0));
      ivec2 tmpvar_85;
      tmpvar_85.x = int((uint(tmpvar_13.y) % 1024u));
      tmpvar_85.y = int((uint(tmpvar_13.y) / 1024u));
      vec4 tmpvar_86;
      tmpvar_86 = texelFetchOffset (sGpuCache, tmpvar_85, 0, ivec2(0, 0));
      vec2 tmpvar_87;
      tmpvar_87 = vec2(textureSize (sColor0, 0));
      vec4 tmpvar_88;
      tmpvar_88.xy = (tmpvar_84.xy + vec2(0.5, 0.5));
      tmpvar_88.zw = (tmpvar_84.zw - vec2(0.5, 0.5));
      vUv_Y = (mix (tmpvar_84.xy, tmpvar_84.zw, f_49) / tmpvar_87);
      vUvBounds_Y = (tmpvar_88 / tmpvar_87.xyxy);
      vec2 tmpvar_89;
      tmpvar_89 = vec2(textureSize (sColor1, 0));
      vec4 tmpvar_90;
      tmpvar_90.xy = (tmpvar_86.xy + vec2(0.5, 0.5));
      tmpvar_90.zw = (tmpvar_86.zw - vec2(0.5, 0.5));
      vUv_U = (mix (tmpvar_86.xy, tmpvar_86.zw, f_49) / tmpvar_89);
      vUvBounds_U = (tmpvar_90 / tmpvar_89.xyxy);
    } else {
      if ((tmpvar_52 == 4)) {
        ivec2 tmpvar_91;
        tmpvar_91.x = int((uint(tmpvar_13.x) % 1024u));
        tmpvar_91.y = int((uint(tmpvar_13.x) / 1024u));
        vec4 tmpvar_92;
        tmpvar_92 = texelFetchOffset (sGpuCache, tmpvar_91, 0, ivec2(0, 0));
        vec2 tmpvar_93;
        tmpvar_93 = vec2(textureSize (sColor0, 0));
        vec4 tmpvar_94;
        tmpvar_94.xy = (tmpvar_92.xy + vec2(0.5, 0.5));
        tmpvar_94.zw = (tmpvar_92.zw - vec2(0.5, 0.5));
        vUv_Y = (mix (tmpvar_92.xy, tmpvar_92.zw, f_49) / tmpvar_93);
        vUvBounds_Y = (tmpvar_94 / tmpvar_93.xyxy);
      };
    };
  };
