#version 150
// composite
// features: ["FAST_PATH", "TEXTURE_2D", "YUV"]
...
void main ()
{
  ...
  vec2 tmpvar_23;
  tmpvar_23 = vec2(textureSize (sColor0, 0));
  vec4 tmpvar_24;
  tmpvar_24.xy = (aUvRect0.xy + vec2(0.5, 0.5));
  tmpvar_24.zw = (aUvRect0.zw - vec2(0.5, 0.5));
  vUV_y = (mix (aUvRect0.xy, aUvRect0.zw, uv_1) / tmpvar_23);
  vUVBounds_y = (tmpvar_24 / tmpvar_23.xyxy);
  vec2 tmpvar_25;
  tmpvar_25 = vec2(textureSize (sColor1, 0));
  vec4 tmpvar_26;
  tmpvar_26.xy = (aUvRect1.xy + vec2(0.5, 0.5));
  tmpvar_26.zw = (aUvRect1.zw - vec2(0.5, 0.5));
  vUV_u = (mix (aUvRect1.xy, aUvRect1.zw, uv_1) / tmpvar_25);
  vUVBounds_u = (tmpvar_26 / tmpvar_25.xyxy);
  vec2 tmpvar_27;
  tmpvar_27 = vec2(textureSize (sColor2, 0));
  vec4 tmpvar_28;
  tmpvar_28.xy = (aUvRect2.xy + vec2(0.5, 0.5));
  tmpvar_28.zw = (aUvRect2.zw - vec2(0.5, 0.5));
  vUV_v = (mix (aUvRect2.xy, aUvRect2.zw, uv_1) / tmpvar_27);
  vUVBounds_v = (tmpvar_28 / tmpvar_27.xyxy);
  vec4 tmpvar_29;
  tmpvar_29.zw = vec2(0.0, 1.0);
  tmpvar_29.xy = tmpvar_3;
