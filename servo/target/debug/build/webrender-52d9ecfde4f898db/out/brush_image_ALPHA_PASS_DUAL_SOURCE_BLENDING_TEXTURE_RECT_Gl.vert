...
void main ()
{
  ...
  if (((tmpvar_37 & 2) != 0)) {
    ...
    if (((tmpvar_37 & 512) != 0)) {
      vec2 tmpvar_63;
      tmpvar_63 = (tmpvar_62.zw - tmpvar_62.xy);
      uv0_56 = (tmpvar_62.xy + (segment_data_35.xy * tmpvar_63));
      uv1_55 = (tmpvar_62.xy + (segment_data_35.zw * tmpvar_63));
    };
  };
  float tmpvar_64;
  if (((tmpvar_37 & 1) != 0)) {
  ...
  v_perspective.x = tmpvar_64;
  vec2 tmpvar_65;
  tmpvar_65 = mix(vec2(1.0, 1.0), vec2(1.0, 1.0), bvec2(((tmpvar_37 & 2048) != 0)));
  uv0_56 = (uv0_56 * tmpvar_65);
  uv1_55 = (uv1_55 * tmpvar_65);
  vec2 tmpvar_66;
  tmpvar_66 = min (uv0_56, uv1_55);
  vec4 tmpvar_67;
  tmpvar_67.xy = (tmpvar_66 + vec2(0.5, 0.5));
  tmpvar_67.zw = (max (uv0_56, uv1_55) - vec2(0.5, 0.5));
  v_uv_sample_bounds = tmpvar_67;
  vec2 tmpvar_68;
  tmpvar_68 = ((tmpvar_46 - local_rect_p0_53) / (local_rect_p1_54 - local_rect_p0_53));
  f_51 = tmpvar_68;
  int tmpvar_69;
  tmpvar_69 = (tmpvar_14.x & 65535);
  int tmpvar_70;
  tmpvar_70 = (tmpvar_14.x >> 16);
  if ((tmpvar_14.y == 1)) {
    int tmpvar_71;
    tmpvar_71 = (instance_resource_address_3 + 2);
    ivec2 tmpvar_72;
    tmpvar_72.x = int((uint(tmpvar_71) % 1024u));
    tmpvar_72.y = int((uint(tmpvar_71) / 1024u));
    vec4 tmpvar_73;
    tmpvar_73 = mix (mix (texelFetchOffset (sGpuCache, tmpvar_72, 0, ivec2(0, 0)), texelFetchOffset (sGpuCache, tmpvar_72, 0, ivec2(1, 0)), tmpvar_68.x), mix (texelFetchOffset (sGpuCache, tmpvar_72, 0, ivec2(2, 0)), texelFetchOffset (sGpuCache, tmpvar_72, 0, ivec2(3, 0)), tmpvar_68.x), tmpvar_68.y);
    f_51 = (tmpvar_73.xy / tmpvar_73.w);
  };
  vec2 tmpvar_74;
  tmpvar_74 = ((local_rect_p1_54 - local_rect_p0_53) / stretch_size_52);
  v_uv = (mix (uv0_56, uv1_55, f_51) - tmpvar_66);
  v_uv = (v_uv * tmpvar_74);
  if ((tmpvar_64 == 0.0)) {
  ...
  tmpvar_75.zw = vec2(textureSize (sColor0));
  v_uv_bounds = tmpvar_75;
  v_tile_repeat_bounds = tmpvar_74;
  float tmpvar_76;
  tmpvar_76 = (float(tmpvar_14.z) / 65535.0);
  bool tmpvar_77;
  bool tmpvar_78;
  tmpvar_78 = bool(0);
  tmpvar_77 = (0 == tmpvar_70);
  if (tmpvar_77) {
    image_data_color_57.w = (tmpvar_59.w * tmpvar_76);
    tmpvar_78 = bool(1);
  };
  tmpvar_77 = !(tmpvar_78);
  if (tmpvar_77) {
    image_data_color_57 = (image_data_color_57 * tmpvar_76);
    tmpvar_78 = bool(1);
  };
  bool tmpvar_79;
  bool tmpvar_80;
  tmpvar_80 = bool(0);
  tmpvar_79 = (0 == tmpvar_69);
  tmpvar_79 = (tmpvar_79 || (2 == tmpvar_69));
  if (tmpvar_79) {
    v_mask_swizzle = vec2(0.0, 1.0);
    v_color = image_data_color_57;
    tmpvar_80 = bool(1);
  };
  tmpvar_79 = (tmpvar_79 || (4 == tmpvar_69));
  tmpvar_79 = (tmpvar_79 && !(tmpvar_80));
  if (tmpvar_79) {
    v_mask_swizzle = vec2(1.0, 0.0);
    v_color = image_data_color_57;
    tmpvar_80 = bool(1);
  };
  tmpvar_79 = (tmpvar_79 || (3 == tmpvar_69));
  tmpvar_79 = (tmpvar_79 && !(tmpvar_80));
  if (tmpvar_79) {
    v_mask_swizzle = vec2(1.0, 0.0);
  ...
  tmpvar_79 = (tmpvar_79 || (1 == tmpvar_69));
  tmpvar_79 = (tmpvar_79 && !(tmpvar_80));
  if (tmpvar_79) {
    vec2 tmpvar_81;
    tmpvar_81.y = 0.0;
    tmpvar_81.x = image_data_color_57.w;
    v_mask_swizzle = tmpvar_81;
    v_color = image_data_color_57;
    tmpvar_80 = bool(1);
  };
  tmpvar_79 = (tmpvar_79 || (5 == tmpvar_69));
  tmpvar_79 = (tmpvar_79 && !(tmpvar_80));
  if (tmpvar_79) {
    vec2 tmpvar_82;
    tmpvar_82.x = -(image_data_color_57.w);
    tmpvar_82.y = image_data_color_57.w;
    v_mask_swizzle = tmpvar_82;
    v_color = image_data_color_57;
    tmpvar_80 = bool(1);
  };
  tmpvar_79 = !(tmpvar_80);
