...
void main ()
{
  ...
  if (((tmpvar_42 == 3) || (tmpvar_42 == 99))) {
    ...
    vec4 tmpvar_67;
    tmpvar_67.xy = (tmpvar_62.xy + vec2(0.5, 0.5));
    tmpvar_67.zw = (tmpvar_62.zw - vec2(0.5, 0.5));
    vUv_Y = mix (tmpvar_62.xy, tmpvar_62.zw, f_39);
    vUvBounds_Y = tmpvar_67;
    vec4 tmpvar_68;
    tmpvar_68.xy = (tmpvar_64.xy + vec2(0.5, 0.5));
    tmpvar_68.zw = (tmpvar_64.zw - vec2(0.5, 0.5));
    vUv_U = mix (tmpvar_64.xy, tmpvar_64.zw, f_39);
    vUvBounds_U = tmpvar_68;
    vec4 tmpvar_69;
    tmpvar_69.xy = (tmpvar_66.xy + vec2(0.5, 0.5));
    tmpvar_69.zw = (tmpvar_66.zw - vec2(0.5, 0.5));
    vUv_V = mix (tmpvar_66.xy, tmpvar_66.zw, f_39);
    vUvBounds_V = tmpvar_69;
  } else {
    if (((tmpvar_42 == 0) || (tmpvar_42 == 1))) {
      ivec2 tmpvar_70;
      tmpvar_70.x = int((uint(tmpvar_11.x) % 1024u));
      tmpvar_70.y = int((uint(tmpvar_11.x) / 1024u));
      vec4 tmpvar_71;
      tmpvar_71 = texelFetchOffset (sGpuCache, tmpvar_70, 0, ivec2(0, 0));
      ivec2 tmpvar_72;
      tmpvar_72.x = int((uint(tmpvar_11.y) % 1024u));
      tmpvar_72.y = int((uint(tmpvar_11.y) / 1024u));
      vec4 tmpvar_73;
      tmpvar_73 = texelFetchOffset (sGpuCache, tmpvar_72, 0, ivec2(0, 0));
      vec4 tmpvar_74;
      tmpvar_74.xy = (tmpvar_71.xy + vec2(0.5, 0.5));
      tmpvar_74.zw = (tmpvar_71.zw - vec2(0.5, 0.5));
      vUv_Y = mix (tmpvar_71.xy, tmpvar_71.zw, f_39);
      vUvBounds_Y = tmpvar_74;
      vec4 tmpvar_75;
      tmpvar_75.xy = (tmpvar_73.xy + vec2(0.5, 0.5));
      tmpvar_75.zw = (tmpvar_73.zw - vec2(0.5, 0.5));
      vUv_U = mix (tmpvar_73.xy, tmpvar_73.zw, f_39);
      vUvBounds_U = tmpvar_75;
    } else {
      if ((tmpvar_42 == 4)) {
        ivec2 tmpvar_76;
        tmpvar_76.x = int((uint(tmpvar_11.x) % 1024u));
        tmpvar_76.y = int((uint(tmpvar_11.x) / 1024u));
        vec4 tmpvar_77;
        tmpvar_77 = texelFetchOffset (sGpuCache, tmpvar_76, 0, ivec2(0, 0));
        vec4 tmpvar_78;
        tmpvar_78.xy = (tmpvar_77.xy + vec2(0.5, 0.5));
        tmpvar_78.zw = (tmpvar_77.zw - vec2(0.5, 0.5));
        vUv_Y = mix (tmpvar_77.xy, tmpvar_77.zw, f_39);
