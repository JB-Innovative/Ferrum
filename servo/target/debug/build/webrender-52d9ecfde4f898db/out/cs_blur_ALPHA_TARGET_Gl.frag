...
void main ()
{
  ...
  avg_color_2 = (texture (sColor0, mix (vUvRect.xy, vUvRect.zw, vUv)).x * vGaussCoefficients.x);
  int tmpvar_5;
  ...
  for (; tmpvar_5 >= i_1; i_1 += 2) {
    ...
    uv1_6 = tmpvar_20;
    avg_color_2 = (avg_color_2 + ((texture (sColor0, tmpvar_19).x + texture (sColor0, tmpvar_20).x) * gauss_coefficient_subtotal_8));
  };
