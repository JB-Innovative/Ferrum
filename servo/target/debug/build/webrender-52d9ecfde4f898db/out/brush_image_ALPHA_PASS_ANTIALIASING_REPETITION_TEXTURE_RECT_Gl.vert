...
void main ()
{
  ...
  ivec2 tmpvar_61;
  tmpvar_61.x = int((uint(instance_resource_address_3) % 1024u));
  tmpvar_61.y = int((uint(instance_resource_address_3) / 1024u));
  vec4 tmpvar_62;
  ...
  if (((tmpvar_37 & 2) != 0)) {
    ...
    vec2 tmpvar_63;
    tmpvar_63 = (segment_rect_p1_34 - segment_rect_p0_33);
    stretch_size_52 = tmpvar_63;
    if (((tmpvar_37 & 512) != 0)) {
      vec2 tmpvar_64;
      tmpvar_64 = (tmpvar_62.zw - tmpvar_62.xy);
      uv0_56 = (tmpvar_62.xy + (segment_data_35.xy * tmpvar_64));
      uv1_55 = (tmpvar_62.xy + (segment_data_35.zw * tmpvar_64));
    };
    if (((tmpvar_37 & 512) != 0)) {
      vec2 vertical_uv_size_65;
      vec2 horizontal_uv_size_66;
      vec2 repeated_stretch_size_67;
      repeated_stretch_size_67 = tmpvar_63;
      vec2 tmpvar_68;
      tmpvar_68 = (uv1_55 - uv0_56);
      horizontal_uv_size_66 = tmpvar_68;
      vec2 tmpvar_69;
      tmpvar_69 = (uv1_55 - uv0_56);
      vertical_uv_size_65 = tmpvar_69;
      if (((tmpvar_37 & 256) != 0)) {
        repeated_stretch_size_67 = (segment_rect_p0_33 - tmpvar_6.xy);
        vertical_uv_size_65.x = (uv0_56.x - tmpvar_62.x);
        if (((vertical_uv_size_65.x < 0.001) || (repeated_stretch_size_67.x < 0.001))) {
          vertical_uv_size_65.x = (tmpvar_62.z - uv1_55.x);
          repeated_stretch_size_67.x = (tmpvar_6.z - segment_rect_p1_34.x);
        };
        horizontal_uv_size_66.y = (uv0_56.y - tmpvar_62.y);
        if (((horizontal_uv_size_66.y < 0.001) || (repeated_stretch_size_67.y < 0.001))) {
          horizontal_uv_size_66.y = (tmpvar_62.w - uv1_55.y);
          repeated_stretch_size_67.y = (tmpvar_6.w - segment_rect_p1_34.y);
        };
      };
      if (((tmpvar_37 & 4) != 0)) {
        stretch_size_52.x = (repeated_stretch_size_67.y * (tmpvar_68.x / horizontal_uv_size_66.y));
      };
      if (((tmpvar_37 & 8) != 0)) {
        stretch_size_52.y = (repeated_stretch_size_67.x * (tmpvar_69.y / vertical_uv_size_65.x));
      };
    } else {
      if (((tmpvar_37 & 4) != 0)) {
    ...
    if (((tmpvar_37 & 16) != 0)) {
      float tmpvar_70;
      tmpvar_70 = (segment_rect_p1_34.x - segment_rect_p0_33.x);
      stretch_size_52.x = (tmpvar_70 / max (1.0, roundEven(
        (tmpvar_70 / stretch_size_52.x)
      )));
    };
    if (((tmpvar_37 & 32) != 0)) {
      float tmpvar_71;
      tmpvar_71 = (segment_rect_p1_34.y - segment_rect_p0_33.y);
      stretch_size_52.y = (tmpvar_71 / max (1.0, roundEven(
        (tmpvar_71 / stretch_size_52.y)
      )));
    };
  };
  float tmpvar_72;
  ...
  v_perspective.x = tmpvar_72;
  vec2 tmpvar_73;
  tmpvar_73 = min (uv0_56, uv1_55);
  vec2 tmpvar_74;
  tmpvar_74 = max (uv0_56, uv1_55);
  vec4 tmpvar_75;
  tmpvar_75.xy = (tmpvar_73 + vec2(0.5, 0.5));
  tmpvar_75.zw = (tmpvar_74 - vec2(0.5, 0.5));
  v_uv_sample_bounds = tmpvar_75;
  vec2 tmpvar_76;
  tmpvar_76 = ((tmpvar_46 - local_rect_p0_53) / (local_rect_p1_54 - local_rect_p0_53));
  f_51 = tmpvar_76;
  int tmpvar_77;
  ...
  if ((tmpvar_14.y == 1)) {
    int tmpvar_79;
    tmpvar_79 = (instance_resource_address_3 + 2);
    ivec2 tmpvar_80;
    tmpvar_80.x = int((uint(tmpvar_79) % 1024u));
    tmpvar_80.y = int((uint(tmpvar_79) / 1024u));
    vec4 tmpvar_81;
    tmpvar_81 = mix (mix (texelFetchOffset (sGpuCache, tmpvar_80, 0, ivec2(0, 0)), texelFetchOffset (sGpuCache, tmpvar_80, 0, ivec2(1, 0)), tmpvar_76.x), mix (texelFetchOffset (sGpuCache, tmpvar_80, 0, ivec2(2, 0)), texelFetchOffset (sGpuCache, tmpvar_80, 0, ivec2(3, 0)), tmpvar_76.x), tmpvar_76.y);
    f_51 = (tmpvar_81.xy / tmpvar_81.w);
  };
  vec2 tmpvar_82;
  tmpvar_82 = ((local_rect_p1_54 - local_rect_p0_53) / stretch_size_52);
  v_uv = (mix (uv0_56, uv1_55, f_51) - tmpvar_73);
  v_uv = (v_uv * tmpvar_82);
  bvec2 tmpvar_83;
  tmpvar_83.x = bool((tmpvar_37 & 64));
  tmpvar_83.y = bool((tmpvar_37 & 128));
  vec2 tmpvar_84;
  tmpvar_84 = mix(vec2(0.0, 0.0), (1.0 - fract(
    ((tmpvar_82 * 0.5) + 0.5)
  )), bvec2(tmpvar_83));
  v_uv = (v_uv + (tmpvar_84 * (tmpvar_74 - tmpvar_73)));
  if ((tmpvar_72 == 0.0)) {
  ...
  v_uv = (v_uv / tmpvar_85);
  v_tile_repeat_bounds = (tmpvar_82 + tmpvar_84);
  float tmpvar_87;
  tmpvar_87 = (float(tmpvar_14.z) / 65535.0);
  bool tmpvar_88;
  bool tmpvar_89;
  tmpvar_89 = bool(0);
  tmpvar_88 = (0 == tmpvar_78);
  if (tmpvar_88) {
  ...
  bool tmpvar_91;
  tmpvar_91 = bool(0);
  tmpvar_90 = (0 == tmpvar_77);
  tmpvar_90 = (tmpvar_90 || (2 == tmpvar_77));
  if (tmpvar_90) {
    v_mask_swizzle = vec2(0.0, 1.0);
    v_color = image_data_color_57;
    tmpvar_91 = bool(1);
  };
  tmpvar_90 = (tmpvar_90 || (4 == tmpvar_77));
  ...
  tmpvar_90 = (tmpvar_90 || (3 == tmpvar_77));
  tmpvar_90 = (tmpvar_90 && !(tmpvar_91));
  if (tmpvar_90) {
    v_mask_swizzle = vec2(1.0, 0.0);
  ...
  tmpvar_90 = (tmpvar_90 || (1 == tmpvar_77));
  tmpvar_90 = (tmpvar_90 && !(tmpvar_91));
  if (tmpvar_90) {
    vec2 tmpvar_92;
    tmpvar_92.y = 0.0;
  ...
  tmpvar_90 = (tmpvar_90 || (5 == tmpvar_77));
  tmpvar_90 = (tmpvar_90 && !(tmpvar_91));
  if (tmpvar_90) {
    vec2 tmpvar_93;
