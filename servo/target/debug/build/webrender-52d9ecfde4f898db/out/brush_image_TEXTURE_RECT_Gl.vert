...
void main ()
{
  ...
  if (((tmpvar_28 & 2) != 0)) {
    ...
    if (((tmpvar_28 & 512) != 0)) {
      vec2 tmpvar_51;
      tmpvar_51 = (tmpvar_50.zw - tmpvar_50.xy);
      uv0_46 = (tmpvar_50.xy + (segment_data_26.xy * tmpvar_51));
      uv1_45 = (tmpvar_50.xy + (segment_data_26.zw * tmpvar_51));
    };
  };
  float tmpvar_52;
  if (((tmpvar_28 & 1) != 0)) {
  ...
  v_perspective.x = tmpvar_52;
  vec2 tmpvar_53;
  tmpvar_53 = mix(vec2(1.0, 1.0), vec2(1.0, 1.0), bvec2(((tmpvar_28 & 2048) != 0)));
  uv0_46 = (uv0_46 * tmpvar_53);
  uv1_45 = (uv1_45 * tmpvar_53);
  vec2 tmpvar_54;
  tmpvar_54 = min (uv0_46, uv1_45);
  vec4 tmpvar_55;
  tmpvar_55.xy = (tmpvar_54 + vec2(0.5, 0.5));
  tmpvar_55.zw = (max (uv0_46, uv1_45) - vec2(0.5, 0.5));
  v_uv_sample_bounds = tmpvar_55;
  vec2 tmpvar_56;
  tmpvar_56 = ((tmpvar_37 - local_rect_p0_43) / (local_rect_p1_44 - local_rect_p0_43));
  f_41 = tmpvar_56;
  if ((tmpvar_12.y == 1)) {
    int tmpvar_57;
    tmpvar_57 = (instance_resource_address_3 + 2);
    ivec2 tmpvar_58;
    ...
    f_41 = (tmpvar_59.xy / tmpvar_59.w);
  };
  v_uv = (mix (uv0_46, uv1_45, f_41) - tmpvar_54);
